...
<form action="codestudent.php" method="POST" enctype="multipart/form-data">
    <div class="form-group"> 
    <!-- <label for=""><h5>Student ID</h5></label>  -->
    ...
    <label for=""><h5>Date of Birth</h5></label> 
     <input class="form-control" type="text" name="edit_dob" id="" placeholder="Enter DOB" value="<?php  echo $r1['DOB']; ?>">
    </div>
